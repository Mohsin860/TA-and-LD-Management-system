...
namespace dbproject
{
    public partial class TAsReg : Form
    {
        ...
        private void Signup()
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string checkUsernameQuery = "SELECT COUNT(*) FROM TAs WHERE username = @Username";
                    ...
                    string insertQuery = "INSERT INTO TAs (FName, LName, username, password, Contact) " +
