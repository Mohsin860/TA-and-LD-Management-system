...
namespace dbproject
{
    public partial class adminEF : Form
    {
        ...
        public adminEF(string username)
        {
            InitializeComponent();
            loggedInUsername = username; // Set the logged-in username
        }

        private void adminEF_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(loggedInUsername))
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    try
                    {
                        ...
                        string query = "SELECT FName, LName, Password, Contact FROM faculty WHERE username = @loggedInUsername";
