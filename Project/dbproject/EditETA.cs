...
namespace dbproject
{
    public partial class EditETA : Form
    {
        ...
        public EditETA(string username)
        {
            InitializeComponent();
        ...
        private void EditETA_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(loggedInUsername))
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    try
                    {
                        ...
                        string query = "SELECT FName, LName, Password, Contact FROM TAs WHERE username = @loggedInUsername";
